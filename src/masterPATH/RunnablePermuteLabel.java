 ...
 * @author nrubanov
 */
public class RunnablePermuteLabel implements Runnable {
    ...
    public void run()  {
        try {
            ...
            Logger.getLogger(RunnablePermuteLabel.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
